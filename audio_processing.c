...
#define FREQ_DIFF		38 //593Hz = 38 * 15.625
#define MAX_FREQ 		39 //we don’t analyze after this index to not use resources for nothing

#define FREQ_DIFF_L 	(FREQ_DIFF-1)
#define FREQ_DIFF_H 	(FREQ_DIFF+1)
...
void sound_remote(float* data){
	...
	//change difficulty
	else if(max_norm_index >= FREQ_DIFF_L  && max_norm_index <= FREQ_DIFF_H){
		state_frequence = 5;
	}
	//aucune directive
	else{
